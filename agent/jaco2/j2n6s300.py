"""
J2n6s300's basic control system
...
class J2n6s300(Jaco2Agent):
    """Robotic arm control architecture of model J2n6s300"""
    ...
    def apply_action(self, action):
        ...
        """
        # Restrict the opes of the gripper
